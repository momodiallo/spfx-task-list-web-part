...
var TaskListWebPart = (function (_super) {
    ...
    function TaskListWebPart() {
        ...
        _this.listViewMode = [{ key: 0, text: "Light Mode" }, { key: 1, text: "Dark Mode" }];
    ...
    TaskListWebPart.prototype.loadLists = function () {
        return this.context.spHttpClient.get(this.context.pageContext.web.absoluteUrl + "/_api/web/lists?$filter=Hidden eq false and BaseTemplate  eq 171", sp_http_1.SPHttpClient.configurations.v1) // sending the request to SharePoint REST API
                    ...
                    groups: [
                        {
                            groupFields: [
                                ...
                                sp_webpart_base_1.PropertyPaneDropdown('viewMode', {
                                ...
                                sp_webpart_base_1.PropertyPaneButton('applyButton', {
                                    text: 'Apply',
                                    disabled: false,
                                    buttonType: sp_webpart_base_1.PropertyPaneButtonType.Hero,
